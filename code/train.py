...
def main(learning_rate, batch_size, max_time, itr, mode='TRAIN', max_gradient_norm=5.0):
  # target input
...
if __name__ == '__main__':
  ...
  with graph.as_default():
    itr = get_iterator(sys.argv[1], sys.argv[2],
      sys.argv[3], sys.argv[4], int(sys.argv[5]), 
      sys.argv[6], sys.argv[7], int(sys.argv[8]),
      int(sys.argv[9]), src_max_len=max_time, tgt_max_len=max_time)
    # pass
    step, loss, logits, target_output = main(0.001, batch_size, max_time, itr)
